...
"\n"
"Usage:\n"
"   vad [options] -i <input-wav> -o <output-vad> -a <input-float> -b <input-float> [-w <output-wav>]\n"
"   vad (-h | --help)\n"
"   vad --version\n"
"\n"
"Options:\n"
...
"   -a float, --input-float-ka=float  k1 increment\n"
"   -b float, --input-float-kb=float  k2 increment\n"
...
int elems_to_args(Elements *elements, DocoptArgs *args, bool help,
    ...
    for (i=0; i < elements->n_options; i++) {
        ...
        } else if (!strcmp(option->olong, "--input-float-ka")) {
            if (option->argument)
                args->input_float_ka = option->argument;
        } else if (!strcmp(option->olong, "--input-float-kb")) {
            if (option->argument)
                args->input_float_kb = option->argument;
...
DocoptArgs docopt(int argc, char *argv[], bool help, const char *version) {
    ...
    Option options[] = {
        ...
        {"-a", "--input-float-ka", 1, 0, NULL},
        {"-b", "--input-float-kb", 1, 0, NULL},
